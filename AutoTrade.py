...
def dbgout(message):
    ...
    slack.chat.post_message('#stocktrade', strbuf)
...
def get_target_price(code):
    ...
    try:
        ...
        target_price = today_open + (lastday_high - lastday_low) * 0.5 # 목표가 계산
        return target_price
...
def buy_etf(code):
    ...
    try:
        ...
        if current_price > target_price and current_price > ma5_price \
            ...
            cpOrder.SetInputValue(7, "2")        # 주문조건 0:기본, 1:IOC - 체결후 남은 수량 취소, 2:FOK - 전량 체결되지 않으면 주문 자체를 취소
...
if __name__ == '__main__': 
    try:
        symbol_list = ['A122630', 'A252670', 'A233740', 'A250780', 'A225130',
             'A280940', 'A261220', 'A217770', 'A295000', 'A176950'] # 자동매매 종목 코드
